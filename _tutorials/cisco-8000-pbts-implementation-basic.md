...
<code>
    PBTS class information:
      class 0: 7 paths, offset 0                    <mark>&larr; 7 TE tunnels for FC0 (hash 0 to hash 6)</mark>
      forward class 4: 1 paths, offset 7            <mark>&larr; 1 TE tunnel for FC4 (hash 7)</mark>
    Load distribution: 0 1 2 3 4 5 6 7 (refcount 3)

    Hash  OK  Interface                 Address
    0     Y   tunnel-te1                point2point <mark>&larr; FC0 tunnel</mark>
    1     Y   named_5                   point2point <mark>&larr; FC0 tunnel</mark>
    2     Y   named_6                   point2point <mark>&larr; FC0 tunnel</mark>
    3     Y   named_7                   point2point <mark>&larr; FC0 tunnel</mark>
    4     Y   tunnel-te0                point2point <mark>&larr; FC0 tunnel</mark>
    5     Y   tunnel-te2                point2point <mark>&larr; FC0 tunnel</mark>
    6     Y   tunnel-te3                point2point <mark>&larr; FC0 tunnel</mark>
    7     Y   named_4                   point2point <mark>&larr; FC4 tunnel</mark>
</code>
</pre>
</div>
...
The feature also comes with default fallback feature which can be customized to offer even more failover flexibility. When there is failure affecting the primary tunnels, traffic can fall back to back up tunnels as configured.

The feature is simple to configure and will be a nice addition to any MPLS-TE engineers toolbox.
