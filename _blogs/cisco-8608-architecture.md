...
For Non-Redundant 8608 configuration, user can use “8608-SYS-NR” PID on CCW.  
 8608 system is shipped with only one RP, one SC, one FS. For Non-Redundant 8608 configuration, user can use “8608-SYS-NR” PID on CCW.
 8608 system is shipped with only one RP, one SC, one FS. Please reach out to [ask-xr-sw-pm@cisco.com](mailto:ask-xr-sw-pm@cisco.com).  
