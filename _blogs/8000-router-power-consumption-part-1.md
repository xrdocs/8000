...
Routers are currently air-cooled; fans push or pull air through the chassis. The airflow path is important as each component heats the air for downstream devices within the chassis. Fan power is highly variable among systems and different operating conditions. For may systems, the highest fan power may be ten times typical. This great range is due to the nature of fan power consumption. The power is a cubic function of the air moved. When fan speeds get into the 80-100% range, their power goes up dramatically. Therefore, software should only set the fans to maximum speed when absolutely necessary.
